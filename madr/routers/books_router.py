...
def create_book(book: BookSchema, session: T_Session, account: CurrentAccount):
    """
...
def delete_book(book_id: int, session: T_Session, account: CurrentAccount):
    """
...
def get_book(book_id: int, session: T_Session, account: CurrentAccount):
    """
